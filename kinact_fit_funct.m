function f = kinact_fit_funct(kinact)
    ...
    k = 87.5; c0 = 1.81; epsmin = 0.15; km = 0.23;
...
% Part 2 - Compare the model results to the experimental data
    ...
    %This is MSE - you can change the cost function here if you want.
